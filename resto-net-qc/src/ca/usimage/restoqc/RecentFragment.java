...
public void onResume()
{
	...
	public Loader<Cursor> onCreateLoader(int id, Bundle args) {
		  String[] projection = { RestoDatabase.ID, RestoDatabase.COL_ETAB, RestoDatabase.COL_INFO, RestoDatabase.COL_ADR, RestoDatabase.COL_DATE_JUGE, RestoDatabase.COL_MONTANT };
	    switch (id){
